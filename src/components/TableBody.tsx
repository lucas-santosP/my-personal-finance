            ...
            <td className="px-2 py-2.5 text-right">
              <div className="flex items-center gap-1 justify-end">
                <button
                  onClick={() => onEdit(e)}
                  title="Edit"
                  className="p-1 rounded text-neutral-400 hover:text-neutral-700 hover:bg-neutral-100 text-xs border border-neutral-200 bg-transparent cursor-pointer"
                >
                  ✎
                </button>
                <button
                  ...
                  title="Delete"
                  className="p-1 rounded text-neutral-400 hover:text-red-600 hover:bg-red-50 hover:border-red-200 text-xs border border-neutral-200 bg-transparent cursor-pointer"
                >
                  ✕
                </button>
              </div>
