  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-200 flex-shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={onAdd}
          className="text-xs text-neutral-500 hover:text-neutral-800 border border-neutral-200 rounded-lg px-2.5 py-1 hover:bg-neutral-50 transition-colors bg-transparent cursor-pointer"
        >
          + Add
        </button>
      </div>
